...
#define POS_OPEN_USB_PORT 0x13 // 打开USB通讯端口 
...
#define POS_PRINT_MODE_BLACK_MARK_LABEL 0x02 // 黑标记标签模式(部分打印机本身硬件支持)


#define POS_PRINT_MODE_WHITE_MARK_LABEL 0x03 //白标记标签模式 (部分打印机本身硬件支持)
#define POS_PRINT_MODE_VIRTUAL_PAGE 0x04 //虚拟页模式（动态库软件仿真）
...
#define POS_CUT_MODE_ALL 0x02 //不区别半/全切刀类弄，直接切纸
...
#define	PRINTER_TYPE 1   ///  1  清单打印机关干部 0   发票打印机
...
#define S_COMMUNICATION_OK	0   ///正常
#define S_COMMUNICATION_FAILED	-1010    ///通讯故障
#define S_DEVICE_FAULT	1011    ///设备故障
#define S_PAPER_OUT	1012    ////缺纸
#define S_PAPER_JAM		1013     ///卡纸
#define S_PAPER_NEAR_END	1014   ///纸将尽
#define S_COVER_OPEN  1015   ///机盖（抬杆）打开  
#define S_DEVICE_BUSY	1016    ////设备忙
